...
public static String appMasterHost_in_MRAppMaster = null;
  ...
  public static void main(String[] args) {	
	  /*
	  Runnable r = new Runnable() {//---new for bft verification
	         ...
	         public void run() {
	     		...
	     		System.out.println("________________________________||inside Runnable run()||_______________________________ x = "+x);
    ...
    try {
      ...
      System.out.println("_________________________________________In main of MRAppMaster.java befor initAndStartAppMaster");
